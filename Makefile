SRC_FILES_C = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c \
...
BONUS_FILES_C = ft_lstnew_bonus.c ft_lstadd_front_bonus.c ft_lstsize_bonus.c \
